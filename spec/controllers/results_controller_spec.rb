  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved result as @result" do
        ...
        post :create, {:result => { "student_id" => "invalid value" }}, valid_session
        assigns(:result).should be_a_new(Result)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested result" do
        ...
        Result.any_instance.should_receive(:update).with({ "student_id" => "1" })
        put :update, {:id => result.to_param, :result => { "student_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the result as @result" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Result.any_instance.stub(:save).and_return(false)
        put :update, {:id => result.to_param, :result => { "student_id" => "invalid value" }}, valid_session
        assigns(:result).should eq(result)
      end
