...
describe AssessmentsController do
  ...
  let(:valid_attributes) { { "subject_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved assessment as @assessment" do
        ...
        post :create, {:assessment => { "subject_id" => "invalid value" }}, valid_session
        assigns(:assessment).should be_a_new(Assessment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested assessment" do
        ...
        Assessment.any_instance.should_receive(:update).with({ "subject_id" => "1" })
        put :update, {:id => assessment.to_param, :assessment => { "subject_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the assessment as @assessment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Assessment.any_instance.stub(:save).and_return(false)
        put :update, {:id => assessment.to_param, :assessment => { "subject_id" => "invalid value" }}, valid_session
        assigns(:assessment).should eq(assessment)
      end
